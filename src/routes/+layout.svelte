...
<div class='bg-side-green w-1/6 border-forest-green border-r-4 fixed left-0 top-0 h-screen'>
	...
	<div>
		...
		<div on:click={() => goto('/')} class = "flex flex-row justify-center items-center mr-4">
			<!-- logo + name -->
		...
		<div>
			...
			<div class="flex flex-col items-center">
				<!-- Profile Picture -->
				<img on:click={() => goto(`/profile/`)} src={pfpURL} alt={"PFP"} class="w-20 h-20 object-fit rounded-full mt-4">
